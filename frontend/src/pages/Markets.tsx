  ...
  return (
    <>
      <PageHeader
        ...
        meta={
          <>
            <Badge tone="pos" dot>NSE OPEN · closes 15:30 IST</Badge>
            <Badge tone="neu">Delayed 0s · direct feed</Badge>
            <Badge tone={isLive ? "pos" : "gold"} dot={isLive}>
              {isLive ? "LIVE DIRECT FEED" : "SIMULATED"}
            </Badge>
          </>
        }
  ...
  return (
    <>
      <PageHeader
        ...
        meta={
          <>
            <Badge tone="neu">Sentiment-FinBERT v1.8.0</Badge>
            <Badge tone="neu">3,412 documents / 48h</Badge>
            <Badge tone={isLive ? "pos" : "gold"} dot={isLive}>
              {isLive ? "LIVE TELEMETRY" : "SIMULATED"}
            </Badge>
          </>
        }
