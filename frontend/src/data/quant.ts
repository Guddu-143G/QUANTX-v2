...
export const CONCENTRATION_METRICS = {
  hhi: 0.083,
  effectivePositions: 12.0,
  largestPosition: { ticker: "RELIANCE", weight: 8.4 },
  top5: 34.2,
  top10: 58.6,
};

export const SECTOR_EXPOSURE_RISK = [
  { sector: "Financials", current: 26.4, limit: 30, used: 88, riskContrib: 32.1 },
  { sector: "Technology", current: 22.1, limit: 25, used: 88, riskContrib: 18.4 },
  { sector: "Energy", current: 18.2, limit: 20, used: 91, riskContrib: 14.2 },
  { sector: "Consumer", current: 11.7, limit: 15, used: 78, riskContrib: 9.6 },
  { sector: "Healthcare", current: 8.3, limit: 15, used: 55, riskContrib: 6.2 },
  { sector: "Industrials", current: 7.2, limit: 10, used: 72, riskContrib: 5.1 },
  { sector: "Other", current: 6.1, limit: 10, used: 61, riskContrib: 14.4 },
];

export const POSITION_RISK = [
  { ticker: "RELIANCE", weight: 8.4, pnl: "+1.2%", beta: 1.13, vol: 24.1, varContrib: 11.2, cvarContrib: 14.1, liquidity: "HIGH", status: "ELEVATED" },
  { ticker: "HDFCBANK", weight: 7.1, pnl: "-0.4%", beta: 1.08, vol: 18.4, varContrib: 14.8, cvarContrib: 16.2, liquidity: "HIGH", status: "NORMAL" },
  { ticker: "INFY", weight: 6.2, pnl: "+0.8%", beta: 0.94, vol: 21.2, varContrib: 8.4, cvarContrib: 9.6, liquidity: "HIGH", status: "NORMAL" },
  { ticker: "LT", weight: 5.8, pnl: "+2.1%", beta: 1.22, vol: 28.4, varContrib: 9.1, cvarContrib: 11.4, liquidity: "MEDIUM", status: "ELEVATED" },
  { ticker: "ICICIBANK", weight: 5.4, pnl: "+0.2%", beta: 1.15, vol: 22.1, varContrib: 8.9, cvarContrib: 10.1, liquidity: "HIGH", status: "NORMAL" },
  { ticker: "TCS", weight: 4.8, pnl: "-0.1%", beta: 0.88, vol: 16.4, varContrib: 5.2, cvarContrib: 6.4, liquidity: "HIGH", status: "NORMAL" },
  { ticker: "TATAMOTORS", weight: 4.2, pnl: "+3.4%", beta: 1.45, vol: 36.2, varContrib: 12.4, cvarContrib: 15.8, liquidity: "MEDIUM", status: "WARNING" },
  { ticker: "SUNPHARMA", weight: 3.8, pnl: "+1.1%", beta: 0.76, vol: 19.8, varContrib: 4.1, cvarContrib: 4.8, liquidity: "MEDIUM", status: "NORMAL" },
  { ticker: "ADANIPORTS", weight: 3.2, pnl: "-1.8%", beta: 1.68, vol: 42.1, varContrib: 14.2, cvarContrib: 18.6, liquidity: "LOW", status: "WARNING" },
];

export const LIQUIDITY_RISK = {
  portfolioAdv: "₹84.2 Cr",
  daysToLiquidate: 2.4,
  maxParticipation: 10,
  bidAskSpread: "6 bps",
  amihud: "0.014",
  stressRisk: "₹42.8 L",
  holdings: [
    { ticker: "RELIANCE", posValue: "₹42 L", adv: "₹18 Cr", days: 0.23, status: "NORMAL" },
    { ticker: "ADANIPORTS", posValue: "₹16 L", adv: "₹1.2 Cr", days: 1.33, status: "WARNING" },
    { ticker: "SUZLON", posValue: "₹8 L", adv: "₹0.15 Cr", days: 5.33, status: "CRITICAL" },
  ]
};

export const MARGIN_LEVERAGE = {
  margin: {
    available: "₹2.4 Cr",
    used: "₹7.6 Cr",
    initial: "₹5.8 Cr",
...
export const CURRENCY_RISK = {
  exposures: [
    { currency: "USD", exposure: 8.2, hedged: 3.5, net: 4.7 },
    { currency: "EUR", exposure: 2.1, hedged: 1.0, net: 1.1 },
    { currency: "GBP", exposure: 1.3, hedged: 0, net: 1.3 }
  ],
  totalFxExposure: 11.6,
  fxVar: "₹12.1 L",
  fxBeta: 0.14
};
