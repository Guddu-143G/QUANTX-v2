...
export const STYLE_FACTORS_RADAR = [
  { factor: "Momentum", portfolio: 82, benchmark: 50 },
  { factor: "Value", portfolio: 64, benchmark: 52 },
  { factor: "Quality", portfolio: 78, benchmark: 55 },
  { factor: "Low Vol", portfolio: 48, benchmark: 50 },
  { factor: "Size", portfolio: 72, benchmark: 60 },
];
...
export const SCENARIOS: Scenario[] = [
  ...
  {
    key: "bank", name: "Banking Crisis", shock: "Financials −20% (Tail Hedge)", impactPct: -3.8, loss: 3960000,
    worstAsset: "AXISBANK", worstAssetPct: -14.2, recovery: "2.8 months", probability: 2.1,
    sectors: [{ s: "Financials", v: -10.0 }, { s: "Auto", v: -4.4 }, { s: "Technology", v: -2.1 }, { s: "Energy", v: -1.2 }, { s: "Consumer", v: -2.4 }],
  ...
  {
    key: "covid", name: "COVID-style Shock", shock: "Mar-2020 replay (Put Collar)", impactPct: -7.8, loss: 8129000,
    worstAsset: "ADANIPORTS", worstAssetPct: -18.2, recovery: "3.6 months", probability: 0.8,
    sectors: [{ s: "Financials", v: -12.4 }, { s: "Auto", v: -14.2 }, { s: "Energy", v: -11.1 }, { s: "Technology", v: -8.4 }, { s: "Healthcare", v: 6.2 }],
    status: "WITHIN LIMITS",
  },
];

export const RISK_LIMITS = [
  { name: "Single stock weight", current: 7.8, limit: 10, unit: "%" },
...
export const ALERTS: Alert[] = [
  { id: "AL-2841", severity: "INFO", title: "Risk Limit Remediated", body: "Portfolio beta normalized to 0.88 (mandate cap 1.10). Auto-hedge sleeve engaged with NIFTY futures. Breach closed and ratified.", time: "11:42:16", source: "risk-engine", ack: true },
  ...
  { id: "AL-2837", severity: "INFO", title: "Concentration Rebalanced", body: "Banking exposure rebalanced to 19.8% (mandate 25%). Risk parameters nominal.", time: "09:22:47", source: "compliance", ack: true },
...
export const AGENT_PROFILES: AgentProfile[] = [
  {
    ...
    status: "ACTIVE",
    latency: "14ms",
    description: "Query parsing, intent decomposition, and specialized multi-agent dispatch.",
  },
  {
    id: "risk_desk_agent",
    ...
    status: "ACTIVE",
    latency: "142ms",
    description: "Parametric, Historical & Monte Carlo VaR/CVaR and 24+ macroeconomic shocks.",
  },
  {
    ...
    icon: "FlaskConical",
    tools: ["get_factor_scores", "get_rolling_ic", "execute_sandboxed_python"],
    status: "ACTIVE",
    latency: "86ms",
    description: "9 factor family analytics, rolling IC tracks, and custom python alpha plugin evaluation.",
  },
  {
    id: "optimizer_agent",
    ...
    icon: "Scale",
    tools: ["execute_portfolio_optimization", "get_binding_constraints", "enforce_ucits_rule"],
    status: "ACTIVE",
    latency: "210ms",
    description: "Single-name & sector caps, UCITS 5/10/40 checks, turnover penalties, and Lagrange multipliers.",
  },
  {
    id: "backtest_agent",
    ...
    icon: "Atom",
    tools: ["trigger_backtest", "get_backtest_tearsheet", "run_monte_carlo_cluster"],
    status: "ACTIVE",
    latency: "340ms",
    description: "Survivorship-bias-free event-driven backtesting with slippage and market impact.",
  },
  {
    ...
    icon: "FileText",
    tools: ["compile_research_memo", "lineage_semantic_anchor", "export_phoenix_trace"],
    status: "ACTIVE",
    latency: "58ms",
...
export type CopilotBlock =
  ...
  | { kind: "latex_formula"; formula: string; explanation?: string }
  | {
      kind: "tool_call";
      call_id: string;
      invoker_agent: string;
      target_agent: string;
      tool_name: string;
...
export const COPILOT_SEED: CopilotMsg[] = [
  { role: "user", text: "Why did portfolio risk increase today?", ts: "09:41" },
  {
    role: "ai",
    ts: "09:41",
    agent_id: "risk_desk_agent",
    agent_name: "Risk Desk Agent",
    agent_role: "Tail Risk & Stress Testing",
    blocks: [
      {
        kind: "tool_call",
        call_id: "call_89f2a0b1-3094",
        invoker_agent: "quantx_router_01",
        target_agent: "risk_desk_agent",
        tool_name: "calculate_portfolio_risk",
        parameters: {
          holdings_data: [
            { ticker: "RELIANCE", quantity: 840, sector: "Energy" },
            { ticker: "HDFCBANK", quantity: 710, sector: "Financials" },
            { ticker: "ICICIBANK", quantity: 620, sector: "Financials" },
            { ticker: "INFY", quantity: 580, sector: "Technology" }
          ],
          method: "Historical",
        ...
        response: {
          status: "success",
          response_timestamp: "2026-08-31T09:41:00Z",
          output: {
            one_day_var_percentage: 0.0177,
            one_day_var_base_currency: 1840000.0,
            cvar_975_percentage: 0.0265,
            cvar_975_base_currency: 2760000.0,
      ...
      { kind: "latex_formula", formula: "\\text{VaR}_{0.95} = -\\text{Percentile}_{0.05}(r) \\quad \\text{and} \\quad \\text{CVaR}_{0.95} = \\mathbb{E}\\left[ -r \\mid -r \\ge \\text{VaR}_{0.95} \\right]", explanation: "Historical tail risk formulation over 500 common sessions" },
