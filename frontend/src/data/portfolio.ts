...
export const ALLOCATION = [
  { key: "Equities", value: 64, color: "var(--color-acc)", detail: "₹6.67 Cr · 21 positions" },
  { key: "Fixed Income", value: 12, color: "var(--color-acc2)", detail: "₹1.25 Cr · G-Sec & AAA Bonds" },
  { key: "Derivatives", value: 6, color: "#9353d3", detail: "₹0.63 Cr · Index Futures & Options" },
  { key: "Commodities", value: 5, color: "var(--color-warn)", detail: "₹0.52 Cr · Gold & Energy ETF" },
  { key: "Alternatives", value: 7, color: "var(--color-gold)", detail: "₹0.73 Cr · REIT & InvIT" },
  { key: "Cash Buffer", value: 6, color: "#4c5a68", detail: "₹0.62 Cr · Liquid Overnight" },
];

export const SECTOR_EXPOSURE = [
  { sector: "Financials", weight: 19.8, limit: 25, bench: 34.2 },
  { sector: "Technology", weight: 19.2, limit: 25, bench: 14.1 },
  { sector: "Energy", weight: 14.8, limit: 20, bench: 11.4 },
  { sector: "Consumer", weight: 11.4, limit: 20, bench: 9.8 },
  { sector: "Healthcare", weight: 9.2, limit: 20, bench: 4.2 },
  { sector: "Industrials", weight: 8.6, limit: 20, bench: 7.6 },
  { sector: "Auto", weight: 6.4, limit: 15, bench: 6.4 },
  { sector: "Utilities", weight: 5.6, limit: 15, bench: 3.1 },
...
export const KPIS = [
  ...
  {
    key: "beta", label: "Portfolio Beta", value: "0.88", raw: 0.88,
    change: -0.06, changeLabel: "vs NIFTY 50", context: "Target 1.00 ± 0.15 · Auto-hedge active",
    seed: 71, tone: "pos" as const, absolute: true,
